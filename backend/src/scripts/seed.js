...
const seedData = async () => {
  try {
    ...
    await CitizenImpact.deleteMany();
    ...
    const users = [
      ...
      { name: 'Assistant Engineer PWD', email: 'ae.pwd.bhopal@mp.gov.in', role: 'Project Officer', departmentId: 'pwd' }
    ];
    ...
    const projects = [
      {
        ...
        budget: 145000000, // 14.5 Cr
        dailyIdleBurn: 80000,
        penaltyActivationDate: threeDaysFromNow,
        penaltyValue: 23000000 // 2.3 Cr Friday penalty
      },
      {
        _id: 'proj_aiims',
        ...
        dailyIdleBurn: 25000,
        penaltyActivationDate: new Date(today.getTime() + 10 * 24 * 60 * 60 * 1000), // 10 days out
      ...
      },
      {
        ...
        budget: 52000000, // 5.2 Cr
        dailyIdleBurn: 40000,
        penaltyActivationDate: oneDayAgo, // Already breached
    ...
    const dependencies = [
      {
        blockedTaskId: tasks[1]._id, // PWD paving blocked by
        blockingTaskId: tasks[0]._id, // Revenue clearance
        dependencyType: 'finish_to_start',
        escalationStatus: 'idle'
      },
      {
        blockedTaskId: tasks[3]._id, // PWD alignment blocked by
        blockingTaskId: tasks[2]._id, // Water supply schedule sign-off
        dependencyType: 'finish_to_start',
        escalationStatus: 'idle'
      },
      {
        blockedTaskId: tasks[5]._id, // PWD foundation blocked by
        blockingTaskId: tasks[4]._id, // Energy pole shifting
        dependencyType: 'finish_to_start',
        escalationStatus: 'idle'
      }
    ];
    ...
    console.log('Seeding Citizen Impacts...');
    const impacts = [
