...
const DEFAULT_CLOCK_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      projectName: 'Bhopal Metro Orange Line (Subhash Nagar to Karond)',
      description: 'Elevated viaduct pier casting and 33KV grid relocation along the 14.99 km Metro corridor.',
      cLockStatus: 'PARTIAL COORDINATION LOCK',
      badgeVariant: 'high',
      ...
      lockReason: '2 pending departmental clearance(s) enforcing physical execution lock.',
      signOffs: [
        { code: 'energy', name: 'MP Poorv Kshetra Vidyut', status: 'BLOCKED', stage: '33KV_GRID_SHIFTING', daysPending: 18, verifiedBy: null, token: null },
        ...
        { code: 'water_supply', name: 'BMC Water Supply', status: 'CLEARED', stage: 'VERIFIED', daysPending: 0, verifiedBy: '[ROLE: EE_WATER_BMC]', token: 'BMC-MET-NOC-1092' },
        { code: 'pwd', name: 'Public Works Department', status: 'CLEARED', stage: 'VERIFIED', daysPending: 0, verifiedBy: '[ROLE: SE_PWD_BHOPAL]', token: 'PWD-MET-NOC-7721' },
      ],
      escalationAction: 'Convene joint session with MPMRCL and Discom engineers.',
    },
    {
      projectId: 'proj_bhadbhada_flyover',
      projectName: 'Bhadbhada Junction 4-Lane Flyover',
      description: '1.2 km grade separator to decongest New Market - Kaliasot axis.',
      cLockStatus: 'CRITICAL INTERLOCK',
      badgeVariant: 'critical',
      dailyIdleBurn: 65000,
      isReleased: false,
      ...
      lockReason: '2 pending departmental clearance(s) enforcing physical execution lock.',
      signOffs: [
        { code: 'revenue', name: 'Revenue Department', status: 'BLOCKED', stage: 'FOREST_TREE_TRANSFER', daysPending: 22, verifiedBy: null, token: null },
        { code: 'pwd', name: 'Public Works Department', status: 'IN_REVIEW', stage: 'FOUNDATION_PILING', daysPending: 9, verifiedBy: null, token: null },
        { code: 'traffic', name: 'Traffic Police Cell', status: 'CLEARED', stage: 'VERIFIED', daysPending: 0, verifiedBy: '[ROLE: ACP_TRAFFIC_BPL]', token: 'TRF-BPL-NOC-3310' },
        { code: 'water_supply', name: 'BMC Water Supply', status: 'CLEARED', stage: 'VERIFIED', daysPending: 0, verifiedBy: '[ROLE: EE_WATER_BMC]', token: 'BMC-WTR-NOC-4481' },
      ],
      escalationAction: 'Expedite Forest Dept compensatory tree planting NOC.',
    },
    {
      projectId: 'proj_hoshangabad_brts',
      projectName: 'Hoshangabad Road Corridor Redesign & Drain Network',
      description: 'Reconstruction of mixed traffic lanes and underground stormwater culvert widening.',
      cLockStatus: 'PARTIAL COORDINATION LOCK',
      badgeVariant: 'high',
      dailyIdleBurn: 90000,
      isReleased: false,
      ...
      lockReason: '2 pending departmental clearance(s) enforcing physical execution lock.',
      signOffs: [
        { code: 'energy', name: 'MP Poorv Kshetra Vidyut', status: 'BLOCKED', stage: 'UNDERGROUND_DUCTING', daysPending: 15, verifiedBy: null, token: null },
        { code: 'telecom', name: 'BSNL / Telecom Desk', status: 'IN_REVIEW', stage: 'OPTICAL_FIBER_RELOC', daysPending: 7, verifiedBy: null, token: null },
        { code: 'pwd', name: 'Public Works Department', status: 'CLEARED', stage: 'VERIFIED', daysPending: 0, verifiedBy: '[ROLE: EE_PWD_ZONE_2]', token: 'PWD-HOS-NOC-9901' },
        { code: 'traffic', name: 'Traffic Police Cell', status: 'CLEARED', stage: 'VERIFIED', daysPending: 0, verifiedBy: '[ROLE: ACP_TRAFFIC_BPL]', token: 'TRF-HOS-NOC-5520' },
      ],
      escalationAction: 'Review joint utility ducting timeline with Discom and BSNL.',
    },
    {
      projectId: 'proj_upper_lake_stp',
      projectName: 'Upper Lake Catchment 50 MLD STP Project',
      ...
      lockReason: '2 pending departmental clearance(s) enforcing physical execution lock.',
      signOffs: [
        { code: 'water_supply', name: 'BMC Water Supply', status: 'BLOCKED', stage: 'POLLUTION_BOARD_CONSENT', daysPending: 26, verifiedBy: null, token: null },
        { code: 'energy', name: 'MP Poorv Kshetra Vidyut', status: 'IN_REVIEW', stage: 'DEDICATED_FEEDER_SETUP', daysPending: 12, verifiedBy: null, token: null },
        { code: 'pwd', name: 'Public Works Department', status: 'CLEARED', stage: 'VERIFIED', daysPending: 0, verifiedBy: '[ROLE: SE_PWD_BHOPAL]', token: 'PWD-STP-NOC-6601' },
        { code: 'bscdc', name: 'Smart City Mission', status: 'CLEARED', stage: 'VERIFIED', daysPending: 0, verifiedBy: '[ROLE: GM_SMART_CITY]', token: 'BSC-STP-NOC-2041' },
      ],
      escalationAction: 'Request priority environmental consent from MP Pollution Control Board.',
    },
    {
      projectId: 'proj_hamidia_smart_corridor',
      projectName: 'Hamidia Hospital Smart Transit Access Corridor',
      ...
      lockReason: '2 pending departmental clearance(s) enforcing physical execution lock.',
      signOffs: [
        { code: 'revenue', name: 'Revenue Department', status: 'BLOCKED', stage: 'OLD_CITY_ENCROACHMENT', daysPending: 31, verifiedBy: null, token: null },
        { code: 'traffic', name: 'Traffic Police Cell', status: 'IN_REVIEW', stage: 'EMERGENCY_AMBULANCE_BAY', daysPending: 10, verifiedBy: null, token: null },
        { code: 'energy', name: 'MP Poorv Kshetra Vidyut', status: 'CLEARED', stage: 'VERIFIED', daysPending: 0, verifiedBy: '[ROLE: EE_MPEB]', token: 'MPEB-HAM-NOC-1823' },
        { code: 'pwd', name: 'Public Works Department', status: 'CLEARED', stage: 'VERIFIED', daysPending: 0, verifiedBy: '[ROLE: EE_PWD_ZONE_1]', token: 'PWD-HAM-NOC-3049' },
      ],
      escalationAction: 'Issue executive directive for emergency corridor right-of-way.',
    }
  ]
};
...
export default function CLockClearanceHub() {
  ...
  const [expandedProjects, setExpandedProjects] = useState({
    ...
    proj_aiims: true,
    proj_kolar: true,
    proj_bhopal_metro: true,
    proj_bhadbhada_flyover: true,
    proj_hoshangabad_brts: true,
    proj_upper_lake_stp: true,
    proj_hamidia_smart_corridor: true,
  });
